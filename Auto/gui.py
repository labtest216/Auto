...
class Application(Tk.Frame):
    ...
    def create_widgets(self):
        # set switches.
        self.led_switch = Tk.Button(self, text='LED '+self.led_status, command=self.led1_set)
        ...
        self.fan_switch = Tk.Button(self, text='FAN '+self.fan_status, command=self.fan1_set)
        ...
        self.pump_switch = Tk.Button(self, text='PUMP '+self.pump_status, command=self.pump1_set)
    ...
    def led_scheduler_set(self):
        schedule.every(2).seconds.do(self.led1_set).tag('led')
